        ...
        return (
            <form ref={form} onSubmit={sendEmail} className={path.includes('/talleres/') ? 'form' : 'ruta'}>
                ...
                <div className='body-form'>
                    ...
                    <input type="tel" name='numero' id='numero' placeholder='Celular' required autoComplete='off'/>
        ...
        return (
            <form ref={form} onSubmit={sendEmail} className={path.includes('/cursos/software/') || path.includes('/cursos/ilustracion/') || path.includes('/cursos/especialidades/') ? "form" : "ruta"}>
                ...
                <div className='body-form'>
                    ...
                    <input type="text" name='nombres' id='nombres' placeholder='Nombre' required/>
                    <input type="text" name='apellidos' id='apellidos' placeholder='Apellidos' required/>
                    <input type="tel" name='numero' id='celular' placeholder='Celular' required autoComplete='off'/>
                    <input type="email" name='email' id='email' placeholder='Email' required autoComplete='off'/>
                    <select id="talleres" name="curso" required>
                        <option value="Adobe Illustrator">Adobe Illustrator</option>
                        <option value="Adobe Photoshop">Adobe Photoshop</option>
                        <option value="Corel Draw">Corel Draw</option>
                        <option value="AutoCAD para Interiores">AutoCAD para Interiores</option>
